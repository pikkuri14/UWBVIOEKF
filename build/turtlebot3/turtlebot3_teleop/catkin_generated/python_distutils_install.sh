...
echo_and_run cd "/root/uwbvio_ws/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/uwbvio_ws/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/root/uwbvio_ws/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
